...
?>
	<div class="card js-card <?if($arResult['VIEW_CATALOG'] == 'table'):?>table-show<?endif;?>" id="<?= $areaId ?>">
        
        <?if($arResult['DELETE']):?>

            <button class="card__delete js-card__delete js-delete-favorite" data-id="<?=$item['ID']?>">
		...
		<div class="card__text">
			...
			<div class="card__footer">
				<div class="card__wrap">
					...
					<button class="add-favorite js-add-favorite js-product-favorite <?if(in_array($item['ID'], $arResult['FAVORITE'])):?> is-active <?endif;?>" data-id="<?=$item['ID']?>" >
