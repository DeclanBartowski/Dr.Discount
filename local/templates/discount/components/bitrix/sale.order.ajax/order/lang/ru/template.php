...
$MESS["MSG_CONFIRM"] = "Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
$MESS["MSG_PERSONAL"] = "Благодарим за оформление заказа на нашем сайте. Вы можете следить за выполнением своего заказа в <a href=\"#LINK_PERSONAL#\">Персональном разделе сайта.</a>";
