...
<script id="basket-item-template" type="text/html">
    <tr>
        <td>
            <a href="#" class="basket-table__info">
                            <span class="basket-table__icon">
                               <img src="img/basket-menu/1.png" alt="">
                            </span>
                <span class="basket-table__text">
                             ...
                             <div class="tag tag-red">
                                <span>
                                    ...
                                    Ножницы Davis, изогнутые, с ТС вставками, длина 18 см
                                  <span class="basket-table__article">
                                Артикул: AS 110-04
                            </span>
                            </span>
        ...
        <td>
            <div class="card__touchspin">
                <input type="text"
                       class="input-touchspin js-input-touchspin"
                       value="1">
            </div>
        </td>
        <td data-text="Стоимость">
            10 000 <span class="rouble">i</span>
            <span class="text-discount">11 000 <span class="rouble">i</span>
                        </span>
        </td>
        <td data-text="Общая стоимость">
            <b>
                10 000 <span class="rouble">i</span>
            </b>
        </td>
        <td>
            <button class="product-delete js-product-delete">
