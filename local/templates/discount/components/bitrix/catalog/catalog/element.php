...
?>
<div class="page-wrap blue-bg pb-0">
    <div class="container">
...
<?$APPLICATION->ShowViewContent('detail_text');?>
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "CACHE_TYPE" => "A",
        "COMPATIBLE_MODE" => "Y",
        "COMPONENT_TEMPLATE" => "recommendation",
        "CONVERT_CURRENCY" => "N",
        "CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:1:5\",\"DATA\":{\"logic\":\"Equal\",\"value\":1}}]}",
        "DETAIL_URL" => "",
...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "PROPERTY_CODE" => array("LIST_WITH_PICTURES", ""),
        "SET_BROWSER_TITLE" => "N",
        "SET_LAST_MODIFIED" => "N",
        "SET_META_DESCRIPTION" => "N",
        "SET_META_KEYWORDS" => "N",
